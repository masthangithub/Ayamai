...
def generate_narrative(entropy_text):
    ...
    """
    output = deepseek_api_generate(entropy_text)
    return output

# --- DeepSeek API Integration ---
DEEPSEEK_API_KEY = "sk-6c4c403030ae4d13909649bd450b2063"  # Inserted user-provided key

def deepseek_api_generate(prompt, api_key=DEEPSEEK_API_KEY, max_tokens=500):
    url = "https://api.deepseek.com/v1/chat/completions"  # Update if your endpoint differs
    headers = {
        "Authorization": f"Bearer {api_key}",
        "Content-Type": "application/json"
    }
    payload = {
        "model": "deepseek-llm-7b-chat",  # Update if you use a different model
        "prompt": prompt,
...
#  This script uses https://api.deepseek.com/v1/chat/completions  models for text generation.
#  Make sure to replace DEEPSEEK_API_KEY with your actual API key.  I have generated.
#  You can get your own API key from https://deepseek.com/developer.
...
#   deepseek url endpoint is not working.
